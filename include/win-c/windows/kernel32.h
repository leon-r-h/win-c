#ifndef WIN_C_KERNEL32_H
#define WIN_C_KERNEL32_H
...
enum win_c_kernel32_codepage : unsigned int {
    ...
    WIN_C_KERNEL32_CODEPAGE_THREAD_ACP = 3,     // Codepage for current thread setting
...
extern int WideCharToMultiByte(enum win_c_kernel32_codepage CodePage, unsigned long dwFlags, unsigned short* lpWideCharStr, int cchWideChar, char* lpMultiByteStr, int cbMultiByte, const char* lpDefaultChar, bool* lpUsedDefaultChar);
